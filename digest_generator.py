...
5. Keep it SHORT — 2-3 bullet points max per section. If there are more
   relevant items than fit, use your judgment on what THIS person would
   care about most — but every item you receive is already confirmed
   relevant to them, not noise to filter further
6. EACH BULLET IS ONE SENTENCE, ONE IDEA. Hard cap: ~20 words per bullet.
   No sub-clauses, no parentheticals, no "and here's more context" run-ons.
   State WHO did WHAT and WHY it matters to this person — nothing else.
   If you can't say it in one clean sentence, cut it down to the single
   most important fact rather than writing a fuller explanation.
7. Write in a warm, professional tone — like a smart colleague briefing them
8. NEVER write generic summaries like "there was discussion about X" 
   — always say WHO said WHAT and WHY it matters to THIS person
9. If there are cross-channel connections, lead with them — they are the most impressive insight
...
if __name__ == "__main__":
    # Test with your seeded dummy users
    TEST_USERS = {
        "U_MARIA": "Maria (Frontend)",
        "U_TOM": "Tom (Backend)",
        "U_JOHN": "John (Backend)",
    }
